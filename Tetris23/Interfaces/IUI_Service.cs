...
namespace Tetris23.Interfaces
{
    ...
    {
        void DrawEmptyBoard(IBoard board, int offsetLeft = 3, int offsetTop = 3);
        void DrawBoardWithShapes(IBoard board, int offsetLeft = 3, int offsetTop = 3);
        ...
        void DrawSpecialMessage(string message, int offsetLeft = 50, int offsetTop = 18, bool clear = false);
    }
}
